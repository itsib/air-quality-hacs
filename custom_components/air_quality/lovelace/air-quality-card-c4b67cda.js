 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
var A;b.finalized=!0,b.elementProperties=new Map,b.elementStyles=[],b.shadowRootOptions={mode:"open"},null==m||m({ReactiveElement:b}),(null!==(p=v.reactiveElementVersions)&&void 0!==p?p:v.reactiveElementVersions=[]).push("1.6.1");const w=window,E=w.trustedTypes,S=E?E.createPolicy("lit-html",{createHTML:t=>t}):void 0,x="$lit$",q=`lit$${(Math.random()+"").slice(9)}$`,C="?"+q,T=`<${C}>`,H=document,I=()=>H.createComment(""),P=t=>null===t||"object"!=typeof t&&"function"!=typeof t,O=Array.isArray,k="[ \t\n\f\r]",N=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,R=/-->/g,U=/>/g,j=RegExp(`>|${k}(?:([^\\s"'>=/]+)(${k}*=${k}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),M=/'/g,D=/"/g,z=/^(?:script|style|textarea|title)$/i,B=(t=>(e,...i)=>({_$litType$:t,strings:e,values:i}))(1),L=Symbol.for("lit-noChange"),F=Symbol.for("lit-nothing"),V=new WeakMap,Q=H.createTreeWalker(H,129,null,!1),W=(t,e)=>{const i=t.length-1,n=[];let s,o=2===e?"<svg>":"",r=N;for(let e=0;e<i;e++){const i=t[e];let a,l,c=-1,d=0;for(;d<i.length&&(r.lastIndex=d,l=r.exec(i),null!==l);)d=r.lastIndex,r===N?"!--"===l[1]?r=R:void 0!==l[1]?r=U:void 0!==l[2]?(z.test(l[2])&&(s=RegExp("</"+l[2],"g")),r=j):void 0!==l[3]&&(r=j):r===j?">"===l[0]?(r=null!=s?s:N,c=-1):void 0===l[1]?c=-2:(c=r.lastIndex-l[2].length,a=l[1],r=void 0===l[3]?j:'"'===l[3]?D:M):r===D||r===M?r=j:r===R||r===U?r=N:(r=j,s=void 0);const h=r===j&&t[e+1].startsWith("/>")?" ":"";o+=r===N?i+T:c>=0?(n.push(a),i.slice(0,c)+x+i.slice(c)+q+h):i+q+(-2===c?(n.push(void 0),e):h)}const a=o+(t[i]||"<?>")+(2===e?"</svg>":"");if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return[void 0!==S?S.createHTML(a):a,n]};class K{constructor({strings:t,_$litType$:e},i){let n;this.parts=[];let s=0,o=0;const r=t.length-1,a=this.parts,[l,c]=W(t,e);if(this.el=K.createElement(l,i),Q.currentNode=this.el.content,2===e){const t=this.el.content,e=t.firstChild;e.remove(),t.append(...e.childNodes)}for(;null!==(n=Q.nextNode())&&a.length<r;){if(1===n.nodeType){if(n.hasAttributes()){const t=[];for(const e of n.getAttributeNames())if(e.endsWith(x)||e.startsWith(q)){const i=c[o++];if(t.push(e),void 0!==i){const t=n.getAttribute(i.toLowerCase()+x).split(q),e=/([.?@])?(.*)/.exec(i);a.push({type:1,index:s,name:e[2],strings:t,ctor:"."===e[1]?Y:"?"===e[1]?et:"@"===e[1]?it:G})}else a.push({type:6,index:s})}for(const e of t)n.removeAttribute(e)}if(z.test(n.tagName)){const t=n.textContent.split(q),e=t.length-1;if(e>0){n.textContent=E?E.emptyScript:"";for(let i=0;i<e;i++)n.append(t[i],I()),Q.nextNode(),a.push({type:2,index:++s});n.append(t[e],I())}}}else if(8===n.nodeType)if(n.data===C)a.push({type:2,index:s});else{let t=-1;for(;-1!==(t=n.data.indexOf(q,t+1));)a.push({type:7,index:s}),t+=q.length-1}s++}}static createElement(t,e){const i=H.createElement("template");return i.innerHTML=t,i}}function X(t,e,i=t,n){var s,o,r,a;if(e===L)return e;let l=void 0!==n?null===(s=i._$Co)||void 0===s?void 0:s[n]:i._$Cl;const c=P(e)?void 0:e._$litDirective$;return(null==l?void 0:l.constructor)!==c&&(null===(o=null==l?void 0:l._$AO)||void 0===o||o.call(l,!1),void 0===c?l=void 0:(l=new c(t),l._$AT(t,i,n)),void 0!==n?(null!==(r=(a=i)._$Co)&&void 0!==r?r:a._$Co=[])[n]=l:i._$Cl=l),void 0!==l&&(e=X(t,l._$AS(t,e.values),l,n)),e}class J{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){var e;const{el:{content:i},parts:n}=this._$AD,s=(null!==(e=null==t?void 0:t.creationScope)&&void 0!==e?e:H).importNode(i,!0);Q.currentNode=s;let o=Q.nextNode(),r=0,a=0,l=n[0];for(;void 0!==l;){if(r===l.index){let e;2===l.type?e=new Z(o,o.nextSibling,this,t):1===l.type?e=new l.ctor(o,l.name,l.strings,this,t):6===l.type&&(e=new nt(o,this,t)),this._$AV.push(e),l=n[++a]}r!==(null==l?void 0:l.index)&&(o=Q.nextNode(),r++)}return Q.currentNode=H,s}v(t){let e=0;for(const i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class Z{constructor(t,e,i,n){var s;this.type=2,this._$AH=F,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=n,this._$Cp=null===(s=null==n?void 0:n.isConnected)||void 0===s||s}get _$AU(){var t,e;return null!==(e=null===(t=this._$AM)||void 0===t?void 0:t._$AU)&&void 0!==e?e:this._$Cp}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===(null==t?void 0:t.nodeType)&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=X(this,t,e),P(t)?t===F||null==t||""===t?(this._$AH!==F&&this._$AR(),this._$AH=F):t!==this._$AH&&t!==L&&this._(t):void 0!==t._$litType$?this.g(t):void 0!==t.nodeType?this.$(t):(t=>O(t)||"function"==typeof(null==t?void 0:t[Symbol.iterator]))(t)?this.T(t):this._(t)}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t))}_(t){this._$AH!==F&&P(this._$AH)?this._$AA.nextSibling.data=t:this.$(H.createTextNode(t)),this._$AH=t}g(t){var e;const{values:i,_$litType$:n}=t,s="number"==typeof n?this._$AC(t):(void 0===n.el&&(n.el=K.createElement(n.h,this.options)),n);if((null===(e=this._$AH)||void 0===e?void 0:e._$AD)===s)this._$AH.v(i);else{const t=new J(s,this),e=t.u(this.options);t.v(i),this.$(e),this._$AH=t}}_$AC(t){let e=V.get(t.strings);return void 0===e&&V.set(t.strings,e=new K(t)),e}T(t){O(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let i,n=0;for(const s of t)n===e.length?e.push(i=new Z(this.k(I()),this.k(I()),this,this.options)):i=e[n],i._$AI(s),n++;n<e.length&&(this._$AR(i&&i._$AB.nextSibling,n),e.length=n)}_$AR(t=this._$AA.nextSibling,e){var i;for(null===(i=this._$AP)||void 0===i||i.call(this,!1,!0,e);t&&t!==this._$AB;){const e=t.nextSibling;t.remove(),t=e}}setConnected(t){var e;void 0===this._$AM&&(this._$Cp=t,null===(e=this._$AP)||void 0===e||e.call(this,t))}}class G{constructor(t,e,i,n,s){this.type=1,this._$AH=F,this._$AN=void 0,this.element=t,this.name=e,this._$AM=n,this.options=s,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=F}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,e=this,i,n){const s=this.strings;let o=!1;if(void 0===s)t=X(this,t,e,0),o=!P(t)||t!==this._$AH&&t!==L,o&&(this._$AH=t);else{const n=t;let r,a;for(t=s[0],r=0;r<s.length-1;r++)a=X(this,n[i+r],e,r),a===L&&(a=this._$AH[r]),o||(o=!P(a)||a!==this._$AH[r]),a===F?t=F:t!==F&&(t+=(null!=a?a:"")+s[r+1]),this._$AH[r]=a}o&&!n&&this.j(t)}j(t){t===F?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=t?t:"")}}class Y extends G{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===F?void 0:t}}const tt=E?E.emptyScript:"";class et extends G{constructor(){super(...arguments),this.type=4}j(t){t&&t!==F?this.element.setAttribute(this.name,tt):this.element.removeAttribute(this.name)}}class it extends G{constructor(t,e,i,n,s){super(t,e,i,n,s),this.type=5}_$AI(t,e=this){var i;if((t=null!==(i=X(this,t,e,0))&&void 0!==i?i:F)===L)return;const n=this._$AH,s=t===F&&n!==F||t.capture!==n.capture||t.once!==n.once||t.passive!==n.passive,o=t!==F&&(n===F||s);s&&this.element.removeEventListener(this.name,this,n),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e,i;"function"==typeof this._$AH?this._$AH.call(null!==(i=null===(e=this.options)||void 0===e?void 0:e.host)&&void 0!==i?i:this.element,t):this._$AH.handleEvent(t)}}class nt{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){X(this,t)}}const st=w.litHtmlPolyfillSupport;null==st||st(K,Z),(null!==(A=w.litHtmlVersions)&&void 0!==A?A:w.litHtmlVersions=[]).push("2.7.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
var ot,rt;class at extends b{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var t,e;const i=super.createRenderRoot();return null!==(t=(e=this.renderOptions).renderBefore)&&void 0!==t||(e.renderBefore=i.firstChild),i}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{var n,s;const o=null!==(n=null==i?void 0:i.renderBefore)&&void 0!==n?n:e;let r=o._$litPart$;if(void 0===r){const t=null!==(s=null==i?void 0:i.renderBefore)&&void 0!==s?s:null;o._$litPart$=r=new Z(e.insertBefore(I(),t),t,void 0,null!=i?i:{})}return r._$AI(t),r})(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),null===(t=this._$Do)||void 0===t||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),null===(t=this._$Do)||void 0===t||t.setConnected(!1)}render(){return L}}at.finalized=!0,at._$litElement$=!0,null===(ot=globalThis.litElementHydrateSupport)||void 0===ot||ot.call(globalThis,{LitElement:at});const lt=globalThis.litElementPolyfillSupport;null==lt||lt({LitElement:at}),(null!==(rt=globalThis.litElementVersions)&&void 0!==rt?rt:globalThis.litElementVersions=[]).push("3.3.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */;var vt;const _t=null!=(null===(vt=window.HTMLSlotElement)||void 0===vt?void 0:vt.prototype.assignedElements)?(t,e)=>t.assignedElements(e):(t,e)=>t.assignedNodes(e).filter((t=>t.nodeType===Node.ELEMENT_NODE));function ft(t){const{slot:e,selector:i}=null!=t?t:{};return pt({descriptor:n=>({get(){var n;const s="slot"+(e?`[name=${e}]`:":not([name])"),o=null===(n=this.renderRoot)||void 0===n?void 0:n.querySelector(s),r=null!=o?_t(o,t):[];return i?r.filter((t=>t.matches(i))):r},enumerable:!0,configurable:!0})})}var mt,yt;!function(t){t.language="language",t.system="system",t.comma_decimal="comma_decimal",t.decimal_comma="decimal_comma",t.space_comma="space_comma",t.none="none"}(mt||(mt={})),function(t){t.language="language",t.system="system",t.am_pm="12",t.twenty_four="24"}(yt||(yt={}));var gt=function(t,e,i,n){n=n||{},i=null==i?{}:i;var s=new Event(e,{bubbles:void 0===n.bubbles||n.bubbles,cancelable:Boolean(n.cancelable),composed:void 0===n.composed||n.composed});return s.detail=i,t.dispatchEvent(s),s},$t="Air Quality",bt="Air quality index (AQI)",At="Air quality index (AQI Instant)",wt="Recommendation:",Et="Health effects:",St={1:{label:"The Air is Clean",effects:"The air quality is considered good. Air pollution does not pose a health hazard.",recommendation:"Nope"},2:{label:"Moderate Pollution",effects:"The air quality is generally acceptable, but some pollutants may pose a danger to people who are particularly sensitive to air pollution.",recommendation:"Elderly people, children, pregnant women and people suffering from heart disease, asthma or other respiratory diseases should limit outdoor activities."},3:{label:"Increased Pollution",effects:"People who are sensitive to air pollution may experience negative effects of pollutants. For the majority of the population, air pollution does not have a noticeable effect on health.",recommendation:"Elderly people, children, pregnant women and people suffering from heart disease, asthma or other respiratory diseases should significantly limit outdoor activities."},4:{label:"High Pollution",effects:"Everyone can feel the negative impact of air pollution on their health; particularly sensitive people can experience serious problems.",recommendation:"Elderly people, children, pregnant women and people suffering from heart disease, asthma or other respiratory diseases should avoid being outdoors. Everyone else, especially children, should limit their outdoor activities."},5:{label:"Very High Pollution",effects:"An emergency situation with the impact of pollution on human health. All population groups are at risk of health deterioration.",recommendation:"Elderly people, children, pregnant women and people suffering from heart disease, asthma or other respiratory diseases should avoid even a short stay outdoors. Everyone else, especially children, should avoid being outdoors."},6:{label:"Climate Catastrophe",effects:"Catastrophic health hazard: There may be serious consequences for human health.",recommendation:"All groups of the population should avoid even a short stay in the open air."},7:{label:"Death and Destruction",effects:"Catastrophic health hazard: serious consequences for human health.",recommendation:"All population groups are advised to stay indoors with filtered air. In the open air, it is necessary to use respirators."}},xt={selector_label:"Choose the AQI calculation method",option_daily:"Average per day",option_hourly:"Instant",toggle_recommendations_label:"Display recommendations in case of environmental pollution.",toggle_first_recommendation:"Display recommendations at the lowest AQI level."},qt={invalid_configuration:"Invalid Configuration",invalid_sensors_count:"The number of Air Quality integration sensors should be 7",invalid_sensor:"Sensor {sensorName} not found"},Ct={card_name:$t,air_quality_index:bt,air_quality_index_instant:At,recommendation:wt,health_effects:Et,aqi_levels:St,configurator:xt,error:qt},Tt="Качество Воздуха",Ht="Индекс качества воздуха (AQI)",It="Индекс качества воздуха (AQI Instant)",Pt="Рекомендации:",Ot="Влияние на здоровье:",kt={1:{label:"Воздух в Норме",effects:"Качество воздуха считается хорошим. Загрязнение воздуха не представляет опасности для здоровья.",recommendation:"Нет"},2:{label:"Небольшое Загрязнение",effects:"Качество воздуха в целом является приемлемым, однако некоторые загрязняющие вещества могут представлять опасность для людей, особо чувствительных к загрязнению воздуха.",recommendation:"Пожилым людям, детям, беременным женщинам и людям, страдающим болезнями сердца, астмой или другими респираторными заболеваниями, следует ограничить пребывание на открытом воздухе."},3:{label:"Повышенное Загрязнение",effects:"Люди, чувствительные к загрязнению воздуха, могут испытывать негативное воздействие загрязняющих веществ. Для основной массы населения загрязнение воздуха не оказывает заметного влияния на здоровье.",recommendation:"Пожилым людям, детям, беременным женщинам и людям, страдающим болезнями сердца, астмой или другими респираторными заболеваниями, следует существенно ограничить пребывание на открытом воздухе."},4:{label:"Высокое Загрязнение",effects:"Каждый человек может ощутить негативное влияние загрязнения воздуха на свое здоровье; особо чувствительные люди могут испытывать серьезные проблемы.",recommendation:"Пожилым людям, детям, беременным женщинам и людям, страдающим болезнями сердца, астмой или другими респираторными заболеваниями, следует избегать пребывания на открытом воздухе. Все остальные, особенно дети, должны ограничить пребывание на открытом воздухе."},5:{label:"Ужасно Задымлено",effects:"Чрезвычайная ситуация с воздействием загрязнения на здоровье человека. Все группы населения подвержены риску ухудшения здоровья.",recommendation:"Пожилым людям, детям, беременным женщинам и людям, страдающим болезнями сердца, астмой или другими респираторными заболеваниями, следует избегать даже кратковременного пребывания на открытом воздухе. Все остальные, особенно дети, должны избегать пребывания на открытом воздухе."},6:{label:"Климатическая Катастрофа",effects:"Катастрофическая опасность для здоровья: могут возникнуть серьезные последствия для здоровья человека.",recommendation:"Всем группам населения следует избегать даже кратковременного пребывания на открытом воздухе."},7:{label:"Смерть и Разрушение",effects:"Катастрофическая опасность для здоровья: серьезные последствия для здоровья человека.",recommendation:"Всем группам населения рекомендуется оставаться в помещениях с отфильтрованным воздухом. На открытом воздухе необходимо пользоваться респираторами."}},Nt={selector_label:"Выберите способ расчета AQI",option_daily:"Средний за сутки",option_hourly:"В реальном времени",toggle_recommendations_label:"Показывать рекомендации при загрязнении окружающей среды.",toggle_first_recommendation:"Показывать рекомендации при самом низком уровне AQI."},Rt={invalid_configuration:"Ошибка в конфигурации",invalid_sensors_count:"Количество датчиков интеграции Air Quality должно быть равно 7",invalid_sensor:"Датчик {sensorName} не найден"},Ut={card_name:Tt,air_quality_index:Ht,air_quality_index_instant:It,recommendation:Pt,health_effects:Ot,aqi_levels:kt,configurator:Nt,error:Rt};const jt={en:Object.freeze({__proto__:null,card_name:$t,air_quality_index:bt,air_quality_index_instant:At,recommendation:wt,health_effects:Et,aqi_levels:St,configurator:xt,error:qt,default:Ct}),ru:Object.freeze({__proto__:null,card_name:Tt,air_quality_index:Ht,air_quality_index_instant:It,recommendation:Pt,health_effects:Ot,aqi_levels:kt,configurator:Nt,error:Rt,default:Ut})};function Mt(t,e){if("string"==typeof e)return e;const i=t.split("."),[n,...s]=i,o=e[n];return o&&"string"!=typeof o?Mt(s&&s.length>0?s.join("."):"",o):o}function Dt(t,e="",i=""){const n=function(){var t;let e=null===(t=localStorage.getItem("selectedLanguage"))||void 0===t?void 0:t.replace(/['"]+/g,"").replace("-","_");return"null"===e&&(e=void 0),e||(e=localStorage.getItem("i18nextLng")),e&&"null"!==e||(e="en"),e}();let s;try{s=Object.assign({},jt[n])}catch(t){s=Object.assign({},jt.en)}let o=Mt(t,s);return void 0===o&&(o=Mt(t,Object.assign({},jt.en))),o&&""!==e&&""!==i&&(o=o.replace(`{${e}}`,i)),null!=o?o:""}var zt;function Bt(t){return t>500?zt.SEVENTH:t>300?zt.SIXTH:t>200?zt.FIFTH:t>150?zt.FOURTH:t>100?zt.THIRD:t>50?zt.SECOND:zt.FIRST}!function(t){t[t.FIRST=1]="FIRST",t[t.SECOND=2]="SECOND",t[t.THIRD=3]="THIRD",t[t.FOURTH=4]="FOURTH",t[t.FIFTH=5]="FIFTH",t[t.SIXTH=6]="SIXTH",t[t.SEVENTH=7]="SEVENTH"}(zt||(zt={}));let Lt=class extends at{constructor(){super(...arguments),this._states=new Map}static get styles(){return d`
    ...
    `}static async getConfigElement(){return await import("./configurator-d94aacc9.js"),document.createElement("air-quality-card-configurator")}static getStubConfig(){return{aqi_type:"daily",enable_recommendation:!0,display_first_recommendation:!1}}setConfig(t){if(!t)throw new Error(Dt("error.invalid_configuration"));t.test_gui&&function(){var t=document.querySelector("home-assistant");if(t=(t=(t=(t=(t=(t=(t=(t=t&&t.shadowRoot)&&t.querySelector("home-assistant-main"))&&t.shadowRoot)&&t.querySelector("app-drawer-layout partial-panel-resolver"))&&t.shadowRoot||t)&&t.querySelector("ha-panel-lovelace"))&&t.shadowRoot)&&t.querySelector("hui-root")){var e=t.lovelace;return e.current_view=t.___curView,e}return null}().setEditMode(!0),this.config=Object.assign({aqi_type:"daily",enable_recommendation:!0,display_first_recommendation:!1},t)}getCardSize(){return 3}shouldUpdate(t){var e;if(!this.config||!this.hass)return!1;this._entitiesIds||(this._entitiesIds=function(t){const e=Object.keys(t.entities).filter((e=>"air_quality"===t.entities[e].platform));if(7!==e.length)throw new Error(Dt("error.invalid_sensors_count"));const i=new Map,n=e.find((t=>/^sensor\.air_quality_aqi_?(?<!instant)$/.test(t)));if(!n)throw new Error(Dt("error.invalid_sensor","sensorName","sensor.air_quality_aqi"));i.set("aqi",n);const s=e.find((t=>t.startsWith("sensor.air_quality_aqi_instant")));if(!s)throw new Error(Dt("error.invalid_sensor","sensorName","sensor.air_quality_aqi_instant"));i.set("aqi_instant",s);const o=e.find((t=>t.startsWith("sensor.air_quality_pm_2_5")));if(!o)throw new Error(Dt("error.invalid_sensor","sensorName","sensor.air_quality_pm_2_5"));i.set("pm_2_5",o);const r=e.find((t=>t.startsWith("sensor.air_quality_pm_10")));if(!r)throw new Error(Dt("error.invalid_sensor","sensorName","sensor.air_quality_pm_10"));i.set("pm_10",r);const a=e.find((t=>t.startsWith("sensor.air_quality_temperature")));if(!a)throw new Error(Dt("error.invalid_sensor","sensorName","sensor.air_quality_temperature"));i.set("temperature",a);const l=e.find((t=>t.startsWith("sensor.air_quality_humidity")));if(!l)throw new Error(Dt("error.invalid_sensor","sensorName","sensor.air_quality_humidity"));i.set("humidity",l);const c=e.find((t=>t.startsWith("sensor.air_quality_pressure")));if(!c)throw new Error(Dt("error.invalid_sensor","sensorName","sensor.air_quality_pressure"));return i.set("pressure",c),i}(this.hass));let i=!1;if(t.has("hass"))for(const t of this._entitiesIds.keys()){const n=this._entitiesIds.get(t),s=null===(e=this.hass.states[n])||void 0===e?void 0:e.state;this._states.get(t)!==s&&(this._states.set(t,s),i=!0)}return t.has("config")&&(i=!0),i}render(){return B`
      <ha-card>
      ...
      <portal></portal>
    `}_renderHeaderBlock(){const t=this._getState("aqi");if(!t)return;const e=Bt(t);return B`
      <button type="button" class="aqi-btn-content" @click=${()=>this._displayDetailEntityInfo("aqi")}>
        <div class="image">
          <img src="${function(t){switch(t){case zt.FIRST:return"/air-quality/level-good.svg";case zt.SECOND:return"/air-quality/level-moderate.svg";case zt.THIRD:return"/air-quality/level-increased.svg";case zt.FOURTH:return"/air-quality/level-high.svg";case zt.FIFTH:case zt.SIXTH:case zt.SEVENTH:return"/air-quality/level-very-high.svg"}}(e)}" alt="AQI Level Icon" width="50" height="50" />
        </div>
        <div class="info">
          <div class="title">${Dt(`aqi_levels.${e}.label`)}</div>
          <div class="aqi-state">${"daily"===this.config.aqi_type?Dt("air_quality_index"):Dt("air_quality_index_instant")}: <b>${t}</b></div>
        </div>
      </button>
    `}_renderEntitiesBlock(){var t,e,i,n,s,o;return B`
      <div class="readings">
    ...
    `}_renderRecommendationBlock(){var t,e;if(!(null===(t=this.config)||void 0===t?void 0:t.enable_recommendation))return;const i=this._getState("aqi");if(!i)return;const n=(null===(e=this.config)||void 0===e?void 0:e.display_first_recommendation)?0:1,s=Bt(i);return s<=n?void 0:B`
      <div class="recommendation">
        <div class="title">${Dt("health_effects")}</div>
        <div class="paragraph">${Dt(`aqi_levels.${s}.effects`)}</div>
        <div class="title">${Dt("recommendation")}</div>
        <div class="paragraph">${Dt(`aqi_levels.${s}.recommendation`)}</div>
      </div>
    `}_getEntityId(t){var e;if(this._entitiesIds)return"aqi"===t?"daily"===(null===(e=this.config)||void 0===e?void 0:e.aqi_type)?this._entitiesIds.get("aqi"):this._entitiesIds.get("aqi_instant"):this._entitiesIds.get(t)}_getState(t){const e=this._states.get(t);if(!e||"unknown"===e)return;const i=Number(e);return isNaN(i)?void 0:i}_displayDetailEntityInfo(t){const e=this._getEntityId(t);e&&gt(this,"hass-more-info",{entityId:e})}};n([ht({attribute:!1})],Lt.prototype,"hass",void 0),n([ut()],Lt.prototype,"config",void 0),Lt=n([ct("air-quality-card")],Lt),window.customCards=window.customCards||[],window.customCards.push({type:"air-quality-card",name:Dt("card_name"),description:"Displays the readings of the weather station sensors. Provided by Air Quality integration.",preview:!0,configurable:!0});export{F as A,h as S,L as T,e as _,i as a,n as b,s as c,Dt as d,ht as e,ct as f,Lt as g,d as i,ft as l,gt as n,pt as o,at as s,ut as t,B as x};
